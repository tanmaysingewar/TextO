    ...
    return (
        <SafeAreaView style={{margin : 25, flex : 1,}}>
            <View style={{ marginTop : 30}}>
                ...
                <Text style={{fontFamily : "Poppins_400Regular" , fontSize : 18, marginTop : 20, textAlign : "center"}}>TextO a simple text sharing application</Text>
            ...
            <View style={{justifyContent: 'flex-end',marginBottom: 36, flex : 1}} >
                <View style={{backgroundColor : "#000", padding : 8, alignItems : "center", borderRadius : 5 }} onTouchEnd={() => navigation.replace("Creator")}>
